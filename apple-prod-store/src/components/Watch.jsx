    ...
    return (
        <div className="flex flex-col items-center justify-around bg-white h-full py-8 px-4">
            <h1 className="2xl:text-4xl xl:text-3xl md:text-2xl font-semibold text-gray-800 mb-8">
                Wich Apple Watch is right for you?
            </h1>
            <div className="w-full flex justify-around">
                ...
                <div className="w-60 h-[430px] flex flex-col justify-around group">
                        ...
                        <div key={index} className="w-full h-64 mb-4 overflow-hidden relative">
                            <img src={watch.imgs[0]} alt={watch.name}
                                className="absolute w-full h-full object-contain opacity-100 group-hover:opacity-0 transition duration-100" />
                            <img src={watch.imgs[1]} alt={watch.name}
                    ...
                    <button className="w-min text-sm mt-4 py-1 px-2 rounded-full bg-blue-400 text-white">Shop</button>
                </div>
                    ))}
            </div>
        </div>
